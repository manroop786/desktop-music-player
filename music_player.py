...
img = PhotoImage(file='images/music 1.png')
next_ = PhotoImage(file = 'images/3.png')
prev = PhotoImage(file='images/4.png')
play = PhotoImage(file='images/2.png')
pause = PhotoImage(file='images/1.png')
